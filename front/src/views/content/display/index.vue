...
export default {
  ...
  created() {
    ...
    const relationJson = [
      JSON.parse(`{"tokens": ["No,", "because", "I", "am", "in", "an", "area", "which", "I", "don't", "know", "where", "the", "enemy", "could", "be", "and", "I", "might", "get", "to", "the", "airplane,", "by", "the", "time", "I", "get", "out", "of", "the", "airplane", "I'm", "thinking", "the", "same", "way"], "e1": { "e": 13, "s": 12, "text": "I", "type": "PER"}, "e2": {"e": 93, "s": 91, "text": "the airplane", "type": "VEH"}, "relation": "ART"}`),
