<template>
  <Row class="row bg-white" style="height: 30rem" :gutter="16">
    <Tabs :animated="false" style="height: 100%;display: flex;flex-direction: column" value="name1" cust-content-class="tabs-container">
...
export default {
  ...
  created() {
    ...
    const relationJson = [
      JSON.parse(`{"tokens": ["No,", "because", "I", "am", "in", "an", "area", "which", "I", "don't", "know", "where", "the", "enemy", "could", "be", "and", "I", "might", "get", "to", "the", "airplane,", "by", "the", "time", "I", "get", "out", "of", "the", "airplane", "I'm", "thinking", "the", "same", "way"], "e1": {"text": "I", "s": 12, "e": 13, "type": "PER"}, "e2": {"text": "the airplane", "s": 91, "e": 93, "type": "VEH"}, "relation": "ART"}`),
